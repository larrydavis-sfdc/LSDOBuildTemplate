...
- [building-lsdo](../../skills/building-lsdo/SKILL.md) — LSDO build standards for demo content created by the DSE advisor
- [building-life-sciences-cloud](../../skills/building-life-sciences-cloud/SKILL.md) — Life Sciences Cloud platform expertise for strategic guidance
- [developing-agentforce](../../skills/developing-agentforce/SKILL.md) — Agentforce architecture and deployment for AI-driven deal narratives
- [sf-lwc-development](../../skills/sf-lwc-development/SKILL.md) — LWC development for custom demo components
- [generating-lightning-app](../../skills/generating-lightning-app/SKILL.md) — generating full Lightning app scaffolds for demos

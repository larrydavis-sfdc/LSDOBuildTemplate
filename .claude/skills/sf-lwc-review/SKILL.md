...
- [sf-lwc-development](../sf-lwc-development/SKILL.md) — core LWC development patterns being reviewed
- [sf-lwc-design](../sf-lwc-design/SKILL.md) — design standards used in the audit
- [sf-lwc-ux](../sf-lwc-ux/SKILL.md) — UX standards used in the audit
- [sf-lwc-styling](../sf-lwc-styling/SKILL.md) — CSS and styling standards used in the audit

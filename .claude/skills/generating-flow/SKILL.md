...
- [developing-agentforce](../developing-agentforce/SKILL.md) — flows invoked as Agentforce agent actions
- [sf-lwc-development](../sf-lwc-development/SKILL.md) — LWC components that launch or embed flows

...
- [generating-custom-tab](../generating-custom-tab/SKILL.md) — tabs bundled into this application
- [generating-lightning-app](../generating-lightning-app/SKILL.md) — full Lightning app scaffold that includes custom applications

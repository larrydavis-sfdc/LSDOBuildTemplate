...
- [building-ui-bundle-frontend](../building-ui-bundle-frontend/SKILL.md) — the frontend context where file upload is added
- [using-ui-bundle-salesforce-data](../using-ui-bundle-salesforce-data/SKILL.md) — saving uploaded files to Salesforce records

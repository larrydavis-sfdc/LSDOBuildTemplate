...
- [generating-custom-object](../generating-custom-object/SKILL.md) — the object this validation rule applies to
- [generating-custom-field](../generating-custom-field/SKILL.md) — fields referenced in the validation rule formula

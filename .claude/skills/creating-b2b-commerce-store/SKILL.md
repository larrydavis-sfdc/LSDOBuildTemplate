...
- [sf-cli-deployment](../sf-cli-deployment/SKILL.md) — sf CLI used to deploy store metadata
- [generating-custom-application](../generating-custom-application/SKILL.md) — custom application metadata that may accompany a commerce store
- [sf-lwc-experience](../sf-lwc-experience/SKILL.md) — Experience Cloud design patterns for storefront components

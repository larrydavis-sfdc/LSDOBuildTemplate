...
- [developing-agentforce](../developing-agentforce/SKILL.md) — authoring the agent that the chat widget connects to
- [building-ui-bundle-frontend](../building-ui-bundle-frontend/SKILL.md) — the frontend context where the chat client is embedded

...
- [developing-agentforce](../developing-agentforce/SKILL.md) — author and deploy agents being observed
- [testing-agentforce](../testing-agentforce/SKILL.md) — structured pre-production testing before observing in prod

...
- [sf-cli-deployment](../sf-cli-deployment/SKILL.md) — deployment commands run after switching to the target org
- [using-cumulusci](../using-cumulusci/SKILL.md) — CumulusCI org management commands for scratch org switching

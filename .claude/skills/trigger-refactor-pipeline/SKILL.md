...
- [generating-apex](../generating-apex/SKILL.md) — generating the handler classes produced by this refactor
- [generating-apex-test](../generating-apex-test/SKILL.md) — auto-generated tests for the refactored trigger handlers
- [sf-apex-development](../sf-apex-development/SKILL.md) — Apex style guide that the handler pattern follows

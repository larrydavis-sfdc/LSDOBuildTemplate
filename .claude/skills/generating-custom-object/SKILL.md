...
- [generating-custom-field](../generating-custom-field/SKILL.md) — add fields to the object being created
- [generating-custom-tab](../generating-custom-tab/SKILL.md) — create a tab to expose this object in the nav bar
- [generating-list-view](../generating-list-view/SKILL.md) — create list views for this object
- [generating-permission-set](../generating-permission-set/SKILL.md) — grant access to this object via permission sets
- [generating-flexipage](../generating-flexipage/SKILL.md) — create a Lightning record page for this object
- [generating-validation-rule](../generating-validation-rule/SKILL.md) — add validation rules to this object

...
- [generating-custom-object](../generating-custom-object/SKILL.md) — the object whose record page is being configured
- [generating-lightning-app](../generating-lightning-app/SKILL.md) — Lightning app the flexipage belongs to
- [sf-lwc-page-composition](../sf-lwc-page-composition/SKILL.md) — App Builder-aware component design patterns for flexipages

...
- [generating-custom-application](../generating-custom-application/SKILL.md) — custom application metadata that ships with the Lightning app
- [generating-flexipage](../generating-flexipage/SKILL.md) — Lightning pages included in the app
- [sf-lwc-development](../sf-lwc-development/SKILL.md) — LWC components that make up the app

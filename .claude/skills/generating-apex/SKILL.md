...
- [generating-apex-test](../generating-apex-test/SKILL.md) — generate test classes for the Apex code you write
- [sf-apex-development](../sf-apex-development/SKILL.md) — NimbleUser style guide and Apex best practices
- [trigger-refactor-pipeline](../trigger-refactor-pipeline/SKILL.md) — refactor triggers into handler patterns with auto-generated tests
- [sf-lwc-development](../sf-lwc-development/SKILL.md) — LWC components that call the Apex methods generated here

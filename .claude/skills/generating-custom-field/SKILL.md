...
- [generating-custom-object](../generating-custom-object/SKILL.md) — the object this field belongs to
- [generating-validation-rule](../generating-validation-rule/SKILL.md) — validation rules that reference this field

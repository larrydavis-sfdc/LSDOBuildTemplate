...
- [using-cumulusci](../using-cumulusci/SKILL.md) — CumulusCI wraps sf CLI for higher-level org automation
- [switching-org](../switching-org/SKILL.md) — switching the active org before deploying
- [deploying-ui-bundle](../deploying-ui-bundle/SKILL.md) — UI bundle deployment that uses sf CLI under the hood

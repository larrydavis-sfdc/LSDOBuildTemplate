...
- [generating-custom-object](../generating-custom-object/SKILL.md) — the object this tab exposes
- [generating-lightning-app](../generating-lightning-app/SKILL.md) — Lightning apps that include this tab
- [generating-custom-application](../generating-custom-application/SKILL.md) — custom applications that bundle this tab

...
- [developing-agentforce](../developing-agentforce/SKILL.md) — agents that use CLTs as structured action input/output schemas
- [generating-custom-object](../generating-custom-object/SKILL.md) — custom objects whose fields inform CLT schema design

...
- [building-ui-bundle-app](../building-ui-bundle-app/SKILL.md) — building a new React app that needs this metadata scaffold
- [generating-ui-bundle-site](../generating-ui-bundle-site/SKILL.md) — site infrastructure that pairs with bundle metadata
- [deploying-ui-bundle](../deploying-ui-bundle/SKILL.md) — deploying the bundle after metadata is generated

...
- [generating-custom-object](../generating-custom-object/SKILL.md) — objects whose access is granted by this permission set
- [building-lsdo](../building-lsdo/SKILL.md) — LSDO naming conventions and standards for permission sets
